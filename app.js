  ...
  switch (randomNumber) {
    case 0:
      document.querySelector("body").style.backgroundImage =
        "url(https://a11an0.github.io/Calculator/images/watercolour-beige.jpg)";
      changeColour("black");
      break;
    case 1:
      document.querySelector("body").style.backgroundImage =
        "url(https://a11an0.github.io/Calculator/images/watercolour-blue.jpg)";
      changeColour("white");
      break;
    case 2:
      document.querySelector("body").style.backgroundImage =
        "url(https://a11an0.github.io/Calculator/images/watercolour-bluyellow.jpg)";
      changeColour("black");
      break;
    case 3:
      document.querySelector("body").style.backgroundImage =
        "url(https://a11an0.github.io/Calculator/images/watercolour-pink.jpg)";
      changeColour("black");
      break;
    case 4:
      document.querySelector("body").style.backgroundImage =
        "url(https://a11an0.github.io/Calculator/images/watercolour-red.jpg)";
      changeColour("white");
      break;
    case 5:
      document.querySelector("body").style.backgroundImage =
        "url(https://a11an0.github.io/Calculator/images/watercolour-pastel.jpg)";
      changeColour("black");
      break;
  }
});
